...
public class MimeMessagePreparatorImplTest {
	...
	public void testAll() throws Exception {
		MimeMessagePreparatorImpl preparator = getPreparatorInstance("Test",
				new HashMap<String, String>(), Locale.FRANCE, MIME_TYPE, LOCATION, FROM);
		...
		when((message.getRecipients(RecipientType.TO))).thenReturn(new Address[] {
	 ...
	 */
	@Test
	public void testCantFindTemplate() throws Exception {
	...
	public void testNoLocale() throws Exception {
		MimeMessagePreparatorImpl preparator = getPreparatorInstance("Test",
				new HashMap<String, String>(), null, MIME_TYPE, LOCATION, FROM);
	 ...
	 */
	@Test
	public void testNoToEmailAddress() throws Exception {
		MimeMessagePreparatorImpl preparator = getPreparatorInstance("Test",
				new HashMap<String, String>(), Locale.FRANCE, MIME_TYPE, LOCATION, FROM);
	 ...
	 */
	@Test
	public void testResolveCorrectMessageEnglish() throws Exception {
		MimeMessagePreparatorImpl preparator = getPreparatorInstance("Test",
				new HashMap<String, String>(), Locale.ENGLISH, MIME_TYPE, LOCATION, FROM);
	 ...
	 */
	@Test
	public void testResolveCorrectMessageFrench() throws Exception {
		MimeMessagePreparatorImpl preparator = getPreparatorInstance("Test",
				new HashMap<String, String>(), Locale.FRANCE, MIME_TYPE, LOCATION, FROM);
	 ...
	 */
	@Test
	public void testResolveDefaultMessageGerman() throws Exception {
		MimeMessagePreparatorImpl preparator = getPreparatorInstance("Test",
				new HashMap<String, String>(), Locale.GERMAN, MIME_TYPE, LOCATION, FROM);
	 ...
	 */
	@Test
	public void testSunnyDayWithParametersAndAttachments() throws Exception {
	 ...
	 */
	@Test
	public void testTemplateLocationNotSet() throws Exception {
		MimeMessagePreparatorImpl preparator = new MimeMessagePreparatorImpl();
	 ...
	 * @return JAVADOC.
	 */
	private Configuration getConfiguration(String location) throws Exception {
